...
const AssignLeadToOperatorModal = ({ visible, onCancel, onOk, leadId, currentOperatorId, loading }) => {
  ...
  return (
    ...
    >
      ...
      <Form form={form} layout="vertical">
        ...
        >
          <Select placeholder="Select operator" allowClear showSearch optionFilterProp="children">
...
export default AssignLeadToOperatorModal;
